...
test('Should work', () => {
    console.log(JSON.stringify(loader.execute('app1', '1.0.0', 'index.js'), null, 2));
});

test('Should work', () => {
    console.log(JSON.stringify(loader.execute('app2', '1.0.0', 'index.js'), null, 2));
});

test('Should work', () => {
    console.log(JSON.stringify(loader.execute('app3', '1.0.0', 'index.js'), null, 2));
});
